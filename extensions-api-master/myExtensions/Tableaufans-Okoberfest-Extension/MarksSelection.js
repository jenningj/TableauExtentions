...
(function () {
  ...
  function writeBackMarks (selectedDataTable) {
	  ...
	  console.log("2. writeBackMarks");
        ...
        console.log('document.getElementById("user_input").value : ' +  document.getElementById("user_input").value);
        ...
        //Test Column Names
        var tentId = selectedDataTable[0][4].formattedValue;
        console.log('selectedDataTable[0][0].formattedValue : ' +  selectedDataTable[0][0].formattedValue);
        console.log('selectedDataTable[0][1].formattedValue : ' +  selectedDataTable[0][1].formattedValue);
        console.log('selectedDataTable[0][2].formattedValue : ' +  selectedDataTable[0][2].formattedValue);
        console.log('selectedDataTable[0][3].formattedValue : ' +  selectedDataTable[0][3].formattedValue);
        console.log('selectedDataTable[0][4].formattedValue : ' +  selectedDataTable[0][4].formattedValue);
        console.log('selectedDataTable[0][5].formattedValue : ' +  selectedDataTable[0][5].formattedValue);
        console.log('selectedDataTable[0][6].formattedValue : ' +  selectedDataTable[0][6].formattedValue);
        //console.log('selectedDataTable[0][7].formattedValue : ' +  selectedDataTable[0][7].formattedValue);
        //console.log('selectedDataTable[0][8].formattedValue : ' +  selectedDataTable[0][8].formattedValue);
        //console.log('selectedDataTable[0][9].formattedValue : ' +  selectedDataTable[0][9].formattedValue);
	...
	var inputSheetIndex;
  	...
  	// alert("worksheets: "+ sheetArray[2].name);
  	 for (var i = 0; i < sheetArray.length; i++) { 
		    if (sheetArray[i].name == "FreeSeats") { 
		    	inputSheetIndex = i;
          ...
          dataSourcesForWorksheet.forEach(function (dataSource) {
            if (!dashboardDataSources[dataSource.id]) { // We've already seen it, skip it.
			 ...
			 // alert("dataSource.name: " + dataSource.name);
			  ...
			  if (dashboardDataSources[dataSource.id].name == "PolygonSingleTent_Hacker+LiveMySql" || dashboardDataSources[dataSource.id].name == "0 tableaufans-oktoberfest-extension-tents")  { 
				  ...
				  refreshDataSource(dashboardDataSources[dataSource.id]);
				  console.log("refreshMySql() was called for fixed datasource names");
			  } 

			 //refreshDataSource(dashboardDataSources["DatasourceMySql"]);
            }
          });
        });
