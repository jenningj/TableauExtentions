...
// import sql from "mssql";
// import sql as mssql from '../node_modules/mssql/bin/mssql.js';



var config = {user: 'Tabeau',
            password:'test',
            server: '(localdb)\\MSSQLLocalDB',
            database: 'Test_Dynamic'};
...
//             request.query('select * from TabExt.tbl_emp', function (err, recordset){
//                 if (err) console.log(err);
